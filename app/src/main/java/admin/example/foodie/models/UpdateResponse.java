...
import admin.example.foodie.models.RestaurantLogIn.perFoodClass;
...
public class UpdateResponse {
    ...
    public UpdateResponse(String rest_id , String _id , String name , List<String> contactNos , List<perFoodClass> foods , String address , List<String> orders) {
